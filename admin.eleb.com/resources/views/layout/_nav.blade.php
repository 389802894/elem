<nav>
    ...
    <p><img style="width: 100px" src="./Uploads/timg.jpg" alt=""><br/>
        登陆名：<strong>匿名</strong><br/>身　份：<strong>管理员</strong></p>
    <?php endif;?>
    <dl>
        <dt><span class="icon board"></span>员工管理</dt>
        <dd>
            <a href="index.php?p=Admin&c=Admin&a=add">-&emsp;添加员工</a>
            <a href="index.php?p=Admin&c=Admin&A=index">-&emsp;员工列表</a>
        </dd>
        <dt><span class="icon news"></span>会员管理</dt>
        <dd>
            <a href="index.php?p=Admin&c=Users&a=index">-&emsp;会员列表</a>
            <a href="index.php?p=Admin&c=Users&a=add">-&emsp;添加会员</a>
        </dd>
